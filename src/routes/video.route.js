...
router.route('/').get(getAllVideos).post(upload.fields([ // this uploader will upload the video to the local file and this local file path is provided to the cloudinary to upload to cloud
    {
        name : "videoFile",
        maxCount : 1
    }, 
